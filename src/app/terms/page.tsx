...
import { ArrowLeft, Gavel, ShieldAlert, Cpu, Scale } from 'lucide-react';
      ...
      <main className="container mx-auto px-6 py-20 max-w-5xl">
        <header className="mb-20">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-6xl font-black tracking-tight uppercase">{t.legal.terms}</h1>
          </div>
          <p className="text-zinc-400 text-xl leading-relaxed max-w-3xl">
            These terms constitute a legally binding agreement for managed security services.
          </p>
        </header>
        ...
        <div className="space-y-24 text-zinc-300 leading-relaxed">
          <section className="space-y-8">
            <div className="flex items-center gap-4 text-white">
              ...
              <h2 className="text-3xl font-black uppercase tracking-wide border-b border-white/10 pb-4 flex-grow">1. Service Delivery</h2>
            </div>
            <p>Redwall provides technical security services on a 24/7/365 basis with defined SLAs.</p>
          </section>
        </div>
        ...
        <div className="mt-40 pt-10 border-t border-white/10 text-center text-zinc-600 text-[11px] font-black uppercase tracking-[0.4em]">
          MSA v4.3 • Effective Jan 2025 • © Redwall Cyber Defense
        </div>
      </main>
    </div>
  );
