    ...
    <div className="flex flex-col min-h-screen bg-black text-white font-body selection:bg-primary/30">
      ...
      <div className="bg-black/80 backdrop-blur-xl border-b border-white/5 py-2 px-8 flex justify-between items-center text-[11px] font-black uppercase tracking-widest sticky top-0 z-[100]">
        ...
        <div className="flex items-center gap-8 text-zinc-500">
          ...
          <button onClick={() => scrollToSection('contact')} className="text-primary hover:text-white transition-colors border-l border-white/10 pl-8">
            {t.nav.emergency}
          </button>
        </div>
      </div>
      ...
      <div className="relative flex flex-col min-h-[90vh]">
        ...
        <header className="relative z-30 pt-10">
          <nav className="px-12 flex items-center justify-between">
            ...
            <Button onClick={() => scrollToSection('contact')} className="bg-primary hover:bg-primary/90 text-white rounded-none px-10 h-16 font-black text-xs tracking-[0.3em] uppercase border-none transition-all shadow-[0_0_20px_rgba(255,0,0,0.3)]">
              {t.nav.getInTouch}
            </Button>
          </nav>
        </header>
        ...
        <main className="flex-grow flex items-center relative z-10">
          <div className="container mx-auto px-12 max-w-[1400px]">
            <div className="max-w-5xl">
              ...
              <p className="text-xl md:text-2xl text-zinc-400 max-w-3xl leading-relaxed mb-16 font-medium">
                {t.hero.sub}
              </p>
              <div className="flex flex-wrap gap-8 items-center">
                 <Button onClick={() => scrollToSection('services')} className="bg-white text-black hover:bg-zinc-200 rounded-none px-12 h-18 font-black uppercase text-xs tracking-[0.4em] shadow-2xl border-none">
                   {t.hero.cta1}
                 </Button>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
              {[t.about.stat1, t.about.stat2, t.about.stat3].map((stat, i) => (
                <div key={i} className="flex flex-col gap-4 group">
                   <div className="text-6xl font-black text-white italic tracking-tighter group-hover:text-primary transition-colors">{stat.value}</div>
                   <div className="flex items-center gap-4">
                      <div className="w-8 h-[1px] bg-primary/30" />
                      <div className="text-[10px] font-black text-zinc-500 tracking-[0.5em] uppercase">{stat.label}</div>
                   </div>
                </div>
              ))}
           </div>
        ...
        <div className="container mx-auto px-12 max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5 border border-white/5">
            {t.services.items.map((service: any) => (
              <div key={service.id} className="group p-12 bg-black hover:bg-[#0a0a0a] transition-all duration-500 flex flex-col h-full relative">
                <div className="flex justify-between items-start mb-16">
                  <div className="w-12 h-12 flex items-center justify-center text-primary border border-primary/20 group-hover:bg-primary group-hover:text-black transition-all duration-500">
                ...
                <h4 className="text-xl font-black text-white mb-6 uppercase tracking-tighter italic group-hover:text-primary transition-colors">{service.title}</h4>
                <p className="text-zinc-500 text-sm leading-relaxed mb-16 flex-grow">{service.desc}</p>
        ...
        <div className="container mx-auto px-12 max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-white/5">
            {t.intel.news.map((item: any, i: number) => (
              <div key={i} className="group cursor-pointer bg-black p-10 hover:bg-[#0a0a0a] transition-all border border-white/5">
                <div className="aspect-square bg-zinc-900 mb-12 overflow-hidden relative border border-white/5">
                ...
                <div className="flex items-center gap-4 text-[9px] font-black text-zinc-600 uppercase tracking-[0.4em] mb-6">
                   <span>{item.date}</span>
                   <div className="w-1 h-1 rounded-full bg-primary" />
                   <span>Classification Level 4</span>
                </div>
                <h4 className="text-2xl font-black text-white group-hover:text-primary transition-colors uppercase italic leading-[1.1]">{item.title}</h4>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="proven-success" className="bg-black py-0 relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
        ...
        <div className="container mx-auto px-12 max-w-[1400px] relative z-10 text-center">
           <div className="max-w-4xl mx-auto space-y-16">
              ...
              <div className="pt-12">
                 <Button className="bg-white text-black hover:bg-zinc-200 rounded-none px-16 h-20 font-black uppercase text-xs tracking-[0.4em] shadow-2xl">
        ...
        <div className="container mx-auto px-12 max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
            <div className="space-y-16">
              ...
              <div className="space-y-12 pt-16 border-t border-white/5">
                <div className="flex items-center gap-10 group">
                  <div className="w-20 h-20 border border-primary/20 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-black transition-all duration-700">
            ...
            <div className="bg-[#050505] p-16 rounded-none border border-white/5 shadow-2xl relative overflow-hidden">
               ...
               {isSubmitted ? (
                 <div className="relative z-10 py-24 flex flex-col items-center text-center animate-in fade-in zoom-in duration-700">
                    <div className="w-24 h-24 border border-primary/30 flex items-center justify-center mb-10">
                      <CheckCircle2 className="w-12 h-12 text-primary" />
                    </div>
                    <h4 className="text-4xl font-black text-white uppercase tracking-tighter mb-6 italic">{t.contact.success}</h4>
                    <p className="text-zinc-500 text-xl max-w-sm mb-12 font-medium">{t.contact.successSub}</p>
                    <Button 
                      variant="outline" 
                      onClick={() => setIsSubmitted(false)}
                      className="border-white/10 text-white hover:bg-white/5 rounded-none px-12 h-16 font-black uppercase text-[10px] tracking-[0.4em]"
                    >
                      {t.contact.another}
                    </Button>
                 </div>
                 ...
                 <Form {...form}>
                   <form onSubmit={form.handleSubmit(onSubmit)} className="relative z-10 space-y-10">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                       <FormField
                         ...
                         render={({ field }) => (
                           <FormItem className="space-y-4">
                             <FormLabel className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.5em]">{t.contact.name}</FormLabel>
                             <FormControl>
                               <Input placeholder="OPERATOR NAME" className="bg-black/50 border-white/10 text-white h-16 rounded-none focus:border-primary text-base placeholder:opacity-20 uppercase font-bold" {...field} />
                             </FormControl>
                       ...
                       <FormField
                         ...
                         render={({ field }) => (
                           <FormItem className="space-y-4">
                             <FormLabel className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.5em]">{t.contact.email}</FormLabel>
                             <FormControl>
                               <Input type="email" placeholder="ENTERPRISE EMAIL" className="bg-black/50 border-white/10 text-white h-16 rounded-none focus:border-primary text-base placeholder:opacity-20 uppercase font-bold" {...field} />
                             </FormControl>
                             <FormMessage className="text-primary text-[9px] font-black uppercase tracking-widest" />
                           </FormItem>
                         )}
                     ...
                     <FormField
                       ...
                       render={({ field }) => (
                         <FormItem className="space-y-4">
                           <FormLabel className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.5em]">{t.contact.message}</FormLabel>
                           <FormControl>
                             <Textarea placeholder="DESCRIBE MISSION REQUIREMENTS..." className="bg-black/50 border-white/10 text-white min-h-[200px] rounded-none focus:border-primary text-base placeholder:opacity-20 uppercase font-bold" {...field} />
                           </FormControl>
                           <FormMessage className="text-primary text-[9px] font-black uppercase tracking-widest" />
                         </FormItem>
                       )}
                     ...
                     <Button 
                       ...
                       className="w-full bg-primary hover:bg-primary/90 text-white font-black uppercase tracking-[0.5em] h-20 rounded-none shadow-2xl flex items-center justify-center gap-6 border-none text-xs transition-all hover:scale-[1.01]"
                     >
                       {isSubmitting ? (
        ...
        <div className="container mx-auto px-12 max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-32">
            <div className="lg:col-span-6">
              ...
              <p className="text-xl max-w-lg mb-16 text-zinc-500 font-medium leading-relaxed">
            ...
            <div className="lg:col-span-3">
               <h3 className="text-white font-black text-xs mb-16 uppercase tracking-[0.5em] border-l-2 border-primary pl-6">Operations</h3>
      ...
      <Dialog open={isHunterOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="bg-black border-white/10 text-white max-w-4xl p-0 overflow-hidden shadow-[0_0_80px_rgba(255,0,0,0.2)] rounded-none">
          <DialogHeader className="p-10 border-b border-white/5 bg-[#050505]">
            <div className="flex items-center gap-6">
               <div className="w-16 h-16 border border-primary/30 flex items-center justify-center text-primary shadow-[0_0_20px_rgba(255,0,0,0.2)]">
               ...
               <div>
                  ...
                  <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.5em]">{t.threatHunter.modalSub}</p>
               </div>
            </div>
          </DialogHeader>
            ...
            {!analysisResult ? (
              <div className="space-y-8">
                <div className="relative">
                  ...
                  <Textarea 
                    ...
                    className="bg-black/50 border-white/10 text-white min-h-[250px] rounded-none focus:border-primary text-base font-mono pl-16 placeholder:opacity-20 py-6"
                  />
                </div>
                <Button 
                  onClick={handleAnalyzeThreat}
                  disabled={isAnalyzing || !threatInput.trim()}
                  className="w-full bg-primary hover:bg-primary/90 text-white font-black uppercase tracking-[0.5em] h-20 rounded-none shadow-2xl flex items-center justify-center gap-6 transition-all hover:scale-[1.01]"
                >
                  {isAnalyzing ? (
              ...
              <div className="space-y-10 animate-in slide-in-from-bottom-8 duration-700">
                 <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    <div className="md:col-span-1 p-8 bg-[#0a0a0a] border border-white/5 text-center flex flex-col items-center justify-center">
                       <div className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-6">{t.threatHunter.severity}</div>
                       <div className={cn(
                    ...
                    <div className="md:col-span-3 p-10 bg-[#0a0a0a] border border-white/5">
                       <div className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.5em] mb-8 flex items-center gap-4">
                 ...
                 <Button 
                   ...
                   variant="outline"
                   className="w-full border-white/10 text-white hover:bg-white/5 rounded-none h-16 font-black uppercase text-[11px] tracking-[0.5em]"
                 >
          ...
          <div className="p-6 bg-[#050505] border-t border-white/5 flex justify-between items-center text-[10px] text-zinc-700 font-black uppercase tracking-[0.3em]">
            <span>REDWALL PRECISION AI OPS V4.0</span>
            <div className="flex items-center gap-6">
               <span className="flex items-center gap-3"><div className="w-2 h-2 rounded-full bg-primary animate-pulse" /> SYSTEM SECURE</span>
      ...
      <Dialog open={isSearchOpen} onOpenChange={setIsSearchOpen}>
        <DialogContent className="bg-black border-white/10 text-white max-w-4xl p-0 overflow-hidden shadow-[0_0_80px_rgba(255,0,0,0.1)] rounded-none">
            ...
            <div className="flex items-center gap-8">
              ...
              <form onSubmit={handleSearch} className="flex-grow">
                <Input 
                  ...
                  className="bg-transparent border-none text-4xl focus-visible:ring-0 placeholder:opacity-10 h-16 p-0 font-black uppercase tracking-tighter italic"
                />
              </form>
            </div>
          </DialogHeader>
          ...
          <div className="p-10 min-h-[450px]">
            {isSearching ? (
              <div className="flex flex-col items-center justify-center h-80 space-y-10">
                <div className="relative w-20 h-20">
                   <div className="absolute inset-0 border-2 border-primary/20 rounded-full" />
                   <div className="absolute inset-0 border-t-2 border-primary rounded-full animate-spin" />
                </div>
                <p className="text-zinc-600 font-black uppercase tracking-[0.5em] text-[11px] animate-pulse">
                  {t.search.analyzing}
                </p>
              </div>
            ) : searchQuery ? (
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                <div className="space-y-8">
                  <h4 className="text-[11px] font-black text-zinc-700 uppercase tracking-[0.6em]">{t.search.results}</h4>
                  <div className="p-8 bg-[#0a0a0a] border border-white/5 flex items-center justify-between group hover:border-primary transition-all cursor-pointer">
                    <div className="flex items-center gap-8">
                      ...
                      <span className="text-2xl font-black uppercase tracking-tighter italic">Precision Intelligence Report: {searchQuery}</span>
                    </div>
                ...
                <div className="py-24 text-center">
                   <p className="text-zinc-700 text-lg italic font-medium tracking-tight">{t.search.noResults}</p>
                </div>
              </div>
            ) : (
              <div className="space-y-16">
                <div className="space-y-8">
                  <h4 className="text-[11px] font-black text-zinc-700 uppercase tracking-[0.6em]">{t.search.quickLinks}</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5">
                    {navItems.map((item) => (
                      <button 
                        ...
                        className="flex items-center gap-6 p-8 bg-black hover:bg-[#0a0a0a] border border-white/5 transition-all text-left group"
                      >
